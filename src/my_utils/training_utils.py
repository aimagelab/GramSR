...
def parse_args(input_args=None):
    ...
    parser.add_argument("--lora_rank_unet_dino", default=4, type=int)

    parser.add_argument("--lora_rank_transformer_pix", default=4, type=int)
    parser.add_argument("--lora_rank_transformer_sem", default=4, type=int)
    parser.add_argument("--lora_rank_transformer_dino", default=4, type=int)
    ...
    # resume
    parser.add_argument("--resume_ckpt", default=0, type=int)#str
